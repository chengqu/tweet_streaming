...
public class KafkaConfig {
	...
	public KafkaSpoutConfig kafkaSpoutConfig() {
		return KafkaSpoutConfig.builder(host, topic).setFirstPollOffsetStrategy(KafkaSpoutConfig.FirstPollOffsetStrategy.UNCOMMITTED_EARLIEST)
				.setGroupId(groupID).setKey(StringDeserializer.class).setValue(AvroDeserializer.class).build();
	}
